<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_NhapHangUpdate.aspx.cs" Inherits="admin_page_module_function_module_NhapHangUpdate" %>
                                    ...
                                    <asp:Repeater runat="server" ID="rp_grvChiTiet">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <input id="<%#Eval("product_id") %>" onchange="myUpdate(<%#Eval("product_id") %>)" class="form-control" style="width: 80px;" value="<%#Eval("nhaphang_chitiet_soluong") %>" type="number" min="1" />
                                                </td>
                                                <td>
                                                    <input style="width: 100px" type="text" onchange="myUpdate(<%#Eval("product_id") %>)" id="txtGiaTien<%#Eval("product_id") %>" class="form-control" value="<%#Eval("nhaphang_gianhap") %>" onkeypress="return isNumberKey(event)" />
                                                </td>
                                                <%-- <td >
