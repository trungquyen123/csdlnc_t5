<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ThongKeXuatSanPham.aspx.cs" Inherits="admin_page_module_function_module_thongke_module_ThongKeXuatSanPham" %>
                                ...
                                <asp:Repeater runat="server" ID="rpNhapHang">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#Eval("xuathang_createdate", "{0: dd/MM/yyyy}") %>
                                            </td>
                                            <td>
                                                <%#Eval("product_title") %>
                                            </td>
                                            <td style="text-align: center">
                                                <%#Eval("xuathang_chitiet_soluong") %>
                                            </td>
                                            <td>
                                                <%#Eval("xuathang_giaxuat") %>
                                            </td>
                                            <td>
                                                <%#Eval("xuathang_thanhtien") %>
                                            </td>
                                            <td>
