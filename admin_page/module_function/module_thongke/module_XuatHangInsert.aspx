<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_XuatHangInsert.aspx.cs" Inherits="admin_page_module_function_module_sanpham_module_XuatHangInsert" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
            ...
            <div class="add_Product row">
                <div class="col-8 card card-block">
                    ...
                    <div class="col-12 form-group">
                        <label class="form-control-label">Nội dung xuất hàng:</label>
                            ...
                            <dx:ASPxGridView ID="grvList" runat="server" CssClass="table-hover col-12" ClientInstanceName="grvList" KeyFieldName="product_id" Width="100%">
                                <Columns>
                                    ...
                                    <dx:GridViewDataColumn Caption="Chi tiết" FieldName="xem" HeaderStyle-HorizontalAlign="Center" Width="10%" HeaderStyle-Font-Bold="true">
                                        <DataItemTemplate>
                                            <a href="#" id="btnChiTiet" runat="server" onclick="return checkNULL()" onserverclick="btnChiTiet_ServerClick">Xuất hàng</a>
                                        </DataItemTemplate>
                                    </dx:GridViewDataColumn>
                                </Columns>
                                    ...
                                    <asp:Repeater runat="server" ID="rp_grvChiTiet">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <input id="<%#Eval("product_id") %>" onchange="myUpdate(<%#Eval("product_id") %>)" type="number" min="1" class="form-control" style="width: 80px;" value="<%#Eval("xuathang_chitiet_soluong") %>" />
                                                </td>
                                              <%--  <td>
                                                    <input style="width: 100px" type="text" id="txtGiaTien<%#Eval("product_id") %>" class="form-control " value="<%#Eval("xuathang_giaxuat") %>" />
                                                </td>--%>
                                                <td>
                    ...
                    <asp:UpdatePanel ID="up_ProductCT" runat="server">
                        <ContentTemplate>
                            <div style="display: none;">
                                ...
                                <a href="javascript:void(0)" id="btnXuatHang" type="button" runat="server" onserverclick="btnXuatHang_ServerClick">Update</a>
                                <%--nút xóa--%>
    ...
    <script>
        ...
        function myUpdate(id) {
            ...
            document.getElementById("<%= btnXuatHang.ClientID%>").click();
        }
        function Delete(id) {
