...
public partial class admin_page_module_function_module_thongke_module_ThongKeTonKho : System.Web.UI.Page
{
    ...
    public void loaddatatable()
    {
        try
        {
            if (dtProduct == null)
            {
                ...
                dtProduct.Columns.Add("tongnhap", typeof(string));
                dtProduct.Columns.Add("tongxuat", typeof(string));
                dtProduct.Columns.Add("conlai", typeof(string));
            }
        }
        catch { }
    }
